...
const WildlifeSection = () => (
  <section id="wildlife" className="py-20 lg:py-28 bg-foreground text-primary-foreground">
    <div className="container mx-auto px-4">
      ...
      >
        <span className="text-sm font-body font-semibold tracking-widest uppercase text-savannah-gold">
        ...
        <p className="text-primary-foreground/60 font-body max-w-xl mx-auto">
          Real-time sighting data from our network of guides across Kenya's national
          parks. Know where to go for the best wildlife encounters.
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
        {bigFive.map((animal, i) => (
          <motion.div
            ...
            className="glass-card-dark p-6 text-center hover:border-savannah-gold/30 transition-colors cursor-pointer"
          >
      ...
      <motion.div
        ...
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        className="mt-14 glass-card-dark p-8 md:p-10 flex flex-col md:flex-row items-center gap-6"
      >
        ...
        <div className="text-center md:text-left flex-1">
          <h3 className="font-display text-xl font-bold mb-1">
            Great Wildebeest Migration — Active Now
          </h3>
          <p className="text-primary-foreground/60 font-body text-sm">
            Over 1.5 million wildebeest are crossing the Mara River. Our AI predicts
            the next major crossing within 48 hours.
          </p>
        </div>
        <button className="gradient-sunset text-primary-foreground rounded-full px-8 py-3 font-body font-semibold text-sm whitespace-nowrap hover:opacity-90 transition-opacity">
          Track Migration
        </button>
      </motion.div>
    </div>
